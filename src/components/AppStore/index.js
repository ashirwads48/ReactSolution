...
class AppStore extends Component {
  ...
  filterAppsList = searchApps => {
    const {activeTabId} = this.setState
    const filterList = searchApps.filter(
  ...
  getSearchResult = () => {
    ...
    const searchResult = appsList.filter(eachApps =>
  ...
  render() {
    ...
    const filterList = this.filterAppsList(searchResult)
